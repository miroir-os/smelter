...
use crate::{
    ...
    wrappers::{
        DecodeInputBufferPool, DecodingQueryPool, H264DecodeProfileInfo,
        OpenCommandBuffer, SeqParameterSetExt, VideoSession,
        h264_level_idc_to_max_dpb_mbs, vk_to_h264_level_idc,
    },
};
...
impl<'a> VideoSessionResources<'a> {
    pub(crate) fn new_from_sps(
        ...
        let max_level_idc = vk_to_h264_level_idc(
            decoding_device.profile_capabilities.h264_decode_capabilities.max_level_idc,
        )?;
