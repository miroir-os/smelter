...
fn test_wgpu_device() -> std::sync::Arc<wgpu::Device> {
    test_wgpu_device_and_queue().0
}

#[cfg(all(test, target_os = "linux"))]
fn test_wgpu_device_and_queue() -> (std::sync::Arc<wgpu::Device>, wgpu::Queue) {
