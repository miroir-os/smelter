...
// ../../node_modules/.pnpm/pino@9.5.0/node_modules/pino/browser.js
var require_browser = __commonJS({
  "../../node_modules/.pnpm/pino@9.5.0/node_modules/pino/browser.js"(exports, module) {
    "use strict";
...
// ../../smelter-web-client/dist/esm/index.mjs
var import_pino = __toESM(require_browser(), 1);

// ../../smelter/esm/component.js
var import_react = __toESM(require_react(), 1);
var DEFAULT_FONT_SIZE = 50;
function createSmelterComponent(sceneBuilder9) {
  return (props) => {
    const { children, ...otherProps } = props;
    const autoId = (0, import_react.useId)();
    return (0, import_react.createElement)("smelter", {
      sceneBuilder: sceneBuilder9,
...
// ../../smelter/esm/components/common.js
function intoApiTransition(transition) {
  return {
    duration_ms: transition.durationMs,
    easing_function: transition.easingFunction ? intoApiEasingFunction(transition.easingFunction) : void 0,
...
function intoApiEasingFunction(easing) {
  ...
  } else if (typeof easing === "object" && (easing.functionName === "linear" || easing.functionName == "bounce")) {
...
function intoApiBoxShadow(boxShadows) {
...
// ../../smelter/esm/components/View.js
var View = createSmelterComponent(sceneBuilder);
...
// ../../smelter/esm/components/Image.js
var import_react5 = __toESM(require_react(), 1);

// ../../smelter/esm/types/refs/imageRef.js
...
// ../../smelter/esm/hooks.js
var import_react4 = __toESM(require_react(), 1);

// ../../smelter/esm/context/index.js
var import_react3 = __toESM(require_react(), 1);

// ../../smelter/esm/types/refs/utils.js
function areRefsEqual(ref1, ref2) {
  const sameType = ref1.type === ref2.type;
  const sameId = ref1.id === ref2.id;
  if (ref1.type === "output-specific-input" && ref2.type === "output-specific-input" || ref1.type === "output-specific-image" && ref2.type === "output-specific-image") {
...
// ../../smelter/esm/context/audioOutputContext.js
var AudioContext = class {
  ...
  getAudioConfig() {
    return this.audioMixerConfig.map((input) => ({
      ...
      volume: Math.min(input.volumeComponents.reduce((acc, opt) => acc + opt.volume, 0), 1)
    }));
  }
  ...
  removeInputAudioComponent(inputRef, options) {
    ...
    if (inputConfig) {
      ...
      if (inputConfig.volumeComponents.length === 0) {
        this.audioMixerConfig = this.audioMixerConfig.filter((config) => !areRefsEqual(config.inputRef, inputRef));
      }
      this.onChange();
    }
  }
...
// ../../smelter/esm/context/timeContext.js
var OfflineTimeContext = class {
  timestamps;
  tasks;
  onChange;
  currentTimestamp = 0;
...
// ../../smelter/esm/context/inputStreamStore.js
var import_react2 = __toESM(require_react(), 1);
var LiveInputStreamStore = class {
  context = {};
  onChangeCallbacks = /* @__PURE__ */ new Set();
  eventQueue;
  logger;
...
var OfflineInputStreamStore = class {
  lastTimestamp = 0;
  context = {};
  inputs = [];
  onChangeCallbacks = /* @__PURE__ */ new Set();
  ...
  setCurrentTimestamp(timestampMs) {
    ...
    this.context = Object.fromEntries(this.inputs.filter((input) => timestampMs >= input.offsetMs).map((input) => {
      const inputState = {
...
var SmelterContext = (0, import_react3.createContext)({
...
function useCurrentTimestamp() {
  const ctx = (0, import_react4.useContext)(SmelterContext);
  const timeContext = ctx.timeContext;
  (0, import_react4.useSyncExternalStore)(timeContext.subscribe, timeContext.getSnapshot);
...
// ../../smelter/esm/components/Image.js
var InnerImage = createSmelterComponent(sceneBuilder2);
function sceneBuilder2(props, _children) {
  return {
    type: "image",
    id: props.id,
...
// ../../smelter/esm/components/Text.js
var Text = createSmelterComponent(sceneBuilder3);
function sceneBuilder3(props, children) {
...
// ../../smelter/esm/components/InputStream.js
var import_react7 = __toESM(require_react(), 1);

// ../../smelter/esm/context/childrenLifetimeContext.js
var import_react6 = __toESM(require_react(), 1);
var ChildrenLifetimeContext = class {
  childrenRefs = /* @__PURE__ */ new Set();
  onChange;
  constructor(onChange) {
    this.onChange = onChange;
  }
...
var ChildrenLifetimeContextType = (0, import_react6.createContext)(new ChildrenLifetimeContext(() => {
}));

// ../../smelter/esm/internal.js
var internal_exports = {};
__export(internal_exports, {
  AudioContext: () => AudioContext,
  ChildrenLifetimeContext: () => ChildrenLifetimeContext,
  ChildrenLifetimeContextType: () => ChildrenLifetimeContextType,
  LiveInputStreamStore: () => LiveInputStreamStore,
  LiveTimeContext: () => LiveTimeContext,
  OfflineInputStreamStore: () => OfflineInputStreamStore,
  OfflineTimeContext: () => OfflineTimeContext,
  SmelterContext: () => SmelterContext,
  SmelterEventType: () => SmelterEventType,
  imageRefIntoRawId: () => imageRefIntoRawId,
  inputRefIntoRawId: () => inputRefIntoRawId,
  parseImageRef: () => parseImageRef,
  parseInputRef: () => parseInputRef
});

// ../../smelter/esm/types/events.js
var SmelterEventType;
(function(SmelterEventType3) {
  SmelterEventType3["AUDIO_INPUT_DELIVERED"] = "AUDIO_INPUT_DELIVERED";
  SmelterEventType3["VIDEO_INPUT_DELIVERED"] = "VIDEO_INPUT_DELIVERED";
  SmelterEventType3["AUDIO_INPUT_PLAYING"] = "AUDIO_INPUT_PLAYING";
  SmelterEventType3["VIDEO_INPUT_PLAYING"] = "VIDEO_INPUT_PLAYING";
  SmelterEventType3["AUDIO_INPUT_EOS"] = "AUDIO_INPUT_EOS";
  SmelterEventType3["VIDEO_INPUT_EOS"] = "VIDEO_INPUT_EOS";
  SmelterEventType3["OUTPUT_DONE"] = "OUTPUT_DONE";
})(SmelterEventType || (SmelterEventType = {}));

// ../../smelter/esm/types/refs/inputRef.js
...
// ../../smelter/esm/components/InputStream.js
var InnerInputStream = createSmelterComponent(sceneBuilder4);
function sceneBuilder4(props, _children) {
  return {
    type: "input_stream",
    id: props.id,
...
// ../../smelter/esm/components/Rescaler.js
var Rescaler = createSmelterComponent(sceneBuilder5);
function sceneBuilder5({ id, style, transition }, children) {
...
// ../../smelter/esm/components/WebView.js
var WebView = createSmelterComponent(sceneBuilder6);
function sceneBuilder6(props, children) {
  return {
    type: "web_view",
    children: children.map(sceneComponentIntoApi),
    id: props.id,
...
// ../../smelter/esm/components/Shader.js
var Shader = createSmelterComponent(sceneBuilder7);
function sceneBuilder7(props, children) {
  return {
    type: "shader",
    children: children.map(sceneComponentIntoApi),
    id: props.id,
...
// ../../smelter/esm/components/Tiles.js
var Tiles = createSmelterComponent(sceneBuilder8);
function sceneBuilder8({ id, style, transition }, children) {
  return {
    type: "tiles",
    id,
    children: children.map(sceneComponentIntoApi),
...
// ../../smelter/esm/components/Show.js
var import_react8 = __toESM(require_react(), 1);

// ../../smelter/esm/components/SlideShow.js
var import_react9 = __toESM(require_react(), 1);

// ../../smelter/esm/components/Mp4.js
var import_react10 = __toESM(require_react(), 1);

// ../../smelter-core/dist/esm/index.mjs
var import_react11 = __toESM(require_react(), 1);
var inputRefIntoRawId2 = internal_exports.inputRefIntoRawId;
var parseInputRef2 = internal_exports.parseInputRef;
function intoRegisterInput(inputId, input) {
  if (input.type === "mp4") {
...
function intoHlsRegisterInput(input) {
  return {
    type: "hls",
    url: input.url,
    required: input.required,
...
function intoWhipRegisterInput(inputId, input) {
  return {
    type: "whip_server",
...
function intoWhepRegisterInput(input) {
  return {
    type: "whep_client",
...
function intoRtmpRegisterInput(input) {
  return {
    type: "rtmp_server",
    url: input.url,
    required: input.required,
...
function intoV4l2RegisterInput(input) {
  return {
    type: "v4l2",
    path: input.path,
...
function intoInputWhipVideoOptions(video) {
  return {
    decoder_preferences: video.decoderPreferences
  };
}
function intoInputWhepVideoOptions(video) {
  return {
    decoder_preferences: video.decoderPreferences
  };
}
...
function intoVideoEncoderBitrate(bitrate) {
...
function intoRegisterWhipClientOutput(output, initial) {
  return {
    type: "whip_client",
...
function intoOutputWhipVideoOptions(video, initial) {
  if (!video || !initial) {
    return void 0;
  }
  return {
    ...
    encoder_preferences: video.encoderPreferences && intoWhipVideoEncoderPreferences(video.encoderPreferences),
    initial
  };
}
function intoWhipVideoEncoderPreferences(encoder_preferences) {
...
function intoOutputWhipAudioOptions(audio, initial) {
  ...
  return {
    ...
    encoder_preferences: audio.encoderPreferences && intoWhipAudioEncoderPreferences(audio.encoderPreferences),
    initial
  };
}
function intoWhipAudioEncoderPreferences(encoder_preferences) {
  return encoder_preferences.map((encoder) => {
    switch (encoder.type) {
      case "opus":
        return {
...
function intoRegisterWhepServerOutput(output, initial) {
  return {
    type: "whep_server",
    bearer_token: output.bearerToken,
...
function intoOutputWhepVideoOptions(video, initial) {
  if (!video || !initial) {
    return void 0;
  }
  return {
...
function intoWhepVideoEncoderOptions(encoder) {
  switch (encoder.type) {
    case "ffmpeg_vp9":
      return {
        type: "ffmpeg_vp9",
...
function intoOutputWhepAudioOptions(audio, initial) {
  return {
    send_eos_when: audio.sendEosWhen && intoOutputEosCondition(audio.sendEosWhen),
...
function intoWhepAudioEncoderOptions(encoder) {
  return {
    type: "opus",
    preset: encoder.preset,
    sample_rate: encoder.sampleRate,
...
function intoOutputRtpVideoOptions(video, initial) {
  return {
    resolution: video.resolution,
    send_eos_when: video.sendEosWhen && intoOutputEosCondition(video.sendEosWhen),
...
function intoRtpVideoEncoderOptions(encoder) {
  switch (encoder.type) {
    case "ffmpeg_vp9":
      return {
        type: "ffmpeg_vp9",
...
function intoOutputMp4VideoOptions(video, initial) {
  return {
    resolution: video.resolution,
    send_eos_when: video.sendEosWhen && intoOutputEosCondition(video.sendEosWhen),
...
function intoMp4VideoEncoderOptions(encoder) {
  switch (encoder.type) {
    case "ffmpeg_h264":
      return {
        type: "ffmpeg_h264",
...
function intoRegisterHlsOutput(output, initial) {
  return {
    type: "hls",
    path: output.serverPath,
...
function intoOutputHlsVideoOptions(video, initial) {
  return {
    resolution: video.resolution,
    send_eos_when: video.sendEosWhen && intoOutputEosCondition(video.sendEosWhen),
...
function intoHlsVideoEncoderOptions(encoder) {
  switch (encoder.type) {
    case "ffmpeg_h264":
      return {
        type: "ffmpeg_h264",
...
function intoOutputHlsAudioOptions(audio, initial) {
  return {
    send_eos_when: audio.sendEosWhen && intoOutputEosCondition(audio.sendEosWhen),
    channels: audio.channels,
...
function intoHlsAudioEncoderOptions(encoder) {
  return {
    type: "aac",
    sample_rate: encoder.sampleRate
  };
}
function intoRegisterRtmpClientOutput(output, initial) {
  return {
    type: "rtmp_client",
    url: output.url,
    video: output.video && initial.video && intoOutputRtmpClientVideoOptions(output.video, initial.video),
    audio: output.audio && initial.audio && intoOutputRtmpClientAudioOptions(output.audio, initial.audio)
  };
}
function intoOutputRtmpClientVideoOptions(video, initial) {
  return {
    resolution: video.resolution,
    send_eos_when: video.sendEosWhen && intoOutputEosCondition(video.sendEosWhen),
...
function intoRtmpClientVideoEncoderOptions(encoder) {
  switch (encoder.type) {
    case "ffmpeg_h264":
      return {
        type: "ffmpeg_h264",
...
function intoOutputRtmpClientAudioOptions(audio, initial) {
  return {
    send_eos_when: audio.sendEosWhen && intoOutputEosCondition(audio.sendEosWhen),
    channels: audio.channels,
...
function intoRtmpClientAudioEncoderOptions(encoder) {
  return {
    type: "aac",
    sample_rate: encoder.sampleRate
  };
...
function intoAudioInputsConfiguration(inputs) {
  return {
    inputs: inputs.map((input) => ({
      input_id: inputRefIntoRawId2(input.inputRef),
      volume: input.volume
    }))
  };
}
var imageRefIntoRawId2 = internal_exports.imageRefIntoRawId;
internal_exports.parseImageRef;
var ApiClient = class {
  serverManager;
  ...
  async registerInput(inputId, request) {
    return this.serverManager.sendRequest({
      method: "POST",
      route: `/api/input/${encodeURIComponent(inputRefIntoRawId2(inputId))}/register`,
      body: request
    });
  }
  async unregisterInput(inputId, body) {
    return this.serverManager.sendRequest({
      method: "POST",
      route: `/api/input/${encodeURIComponent(inputRefIntoRawId2(inputId))}/unregister`,
      body
    });
  }
  ...
  async registerImage(imageRef, request) {
    return this.serverManager.sendRequest({
      method: "POST",
      route: `/api/image/${encodeURIComponent(imageRefIntoRawId2(imageRef))}/register`,
      body: request
    });
  }
  async unregisterImage(imageRef, body) {
    return this.serverManager.sendRequest({
      method: "POST",
      route: `/api/image/${encodeURIComponent(imageRefIntoRawId2(imageRef))}/unregister`,
      body
    });
  }
...
function requireReactReconciler_development() {
  ...
  if (true) {
    reactReconciler_development.exports = function $$$reconciler($$$hostConfig) {
      var exports = {};
      var React = import_react11.default;
      ...
      function popHydrationState(fiber) {
        ...
        if (fiber.tag !== HostRoot && (fiber.tag !== HostComponent2 || shouldDeleteUnhydratedTailInstances(fiber.type) && !shouldSetTextContent(fiber.type, fiber.memoizedProps))) {
          var nextInstance = nextHydratableInstance;
          if (nextInstance) {
            if (shouldClientRenderOnMismatch(fiber)) {
      ...
      function matchSelector(fiber, selector) {
        switch (selector.$$typeof) {
          ...
          case ROLE_TYPE:
            ...
            break;
          case TEXT_TYPE:
            if (fiber.tag === HostComponent2 || fiber.tag === HostText) {
...
var HostComponent = class {
  ...
  sceneBuilder;
  children = [];
  constructor(props, sceneBuilder9) {
    this.props = props;
    this.sceneBuilder = sceneBuilder9;
  }
  scene() {
...
var HostConfig = {
  ...
  preparePortalMount(_rootContainer) {
   ...
   */
  createContainerChildSet(_rootContainer) {
    return [];
  },
  appendChildToContainerChildSet(childSet, child) {
    childSet.push(child);
  },
  finalizeContainerChildren(_rootContainer, _newChildren) {
  },
  /*
   * Replace entire tree in the RootContainer
   */
  replaceContainerChildren(rootContainer, newChildren) {
...
var CompositorRenderer = Reconciler(HostConfig);
var Renderer = class {
  logger;
  rootNode;
...
var StateGuard = class {
  ...
  async run(fn) {
    ...
    if (this.state.type === "shared") {
      ...
      this.state = { type: "shared", promises: /* @__PURE__ */ new Set([promise]) };
    }
    try {
      return await fn();
    } finally {
...
var globalDelayRef = /* @__PURE__ */ Symbol();
function OutputRootComponent({ outputContext, outputRoot, childrenLifetimeContext }) {
  ...
  return (0, import_react11.createElement)(internal_exports.SmelterContext.Provider, { value: outputContext }, (0, import_react11.createElement)(internal_exports.ChildrenLifetimeContextType.Provider, { value: childrenLifetimeContext }, outputRoot));
}
function useMinimalStreamDuration(childrenLifetimeContext) {
  ...
  const afterTimestamp = useAfterTimestamp(1e3);
  (0, import_react11.useEffect)(() => {
    if (afterTimestamp) {
      childrenLifetimeContext.removeRef(globalDelayRef);
    }
...
var Output = class {
  ...
  constructor(outputId, root, registerRequest, api, store, startTimestamp, logger) {
    ...
    this.audioContext = new internal_exports.AudioContext(onUpdate);
    this.timeContext = new internal_exports.LiveTimeContext();
    this.internalInputStreamStore = new internal_exports.LiveInputStreamStore(this.logger);
    if (startTimestamp !== void 0) {
      this.timeContext.initClock(startTimestamp);
    }
    const rootElement = (0, import_react11.createElement)(OutputRootComponent, {
      outputContext: new OutputContext$1(this, this.outputId, store),
      outputRoot: root,
      childrenLifetimeContext: new internal_exports.ChildrenLifetimeContext(() => {
      })
    });
  ...
  scene() {
    const audio = this.supportsAudio ? intoAudioInputsConfiguration(this.audioContext.getAudioConfig()) : void 0;
    const video = this.supportsVideo ? { root: this.renderer.scene() } : void 0;
    return {
      audio,
      video
    };
...
var OutputContext$1 = class OutputContext {
...
var SmelterEventType2 = internal_exports.SmelterEventType;
function parseEvent(event, logger) {
  if (!event.type) {
    logger.error(`Malformed event: ${event}`);
    return null;
  } else if ([
    SmelterEventType2.VIDEO_INPUT_DELIVERED,
    SmelterEventType2.AUDIO_INPUT_DELIVERED,
    SmelterEventType2.VIDEO_INPUT_PLAYING,
    SmelterEventType2.AUDIO_INPUT_PLAYING,
    SmelterEventType2.VIDEO_INPUT_EOS,
    SmelterEventType2.AUDIO_INPUT_EOS
  ].includes(event.type)) {
    return { type: event.type, inputRef: parseInputRef2(event.input_id) };
  } else if (SmelterEventType2.OUTPUT_DONE === event.type) {
...
function handleEvent(store, outputs, event) {
  if (event.type === SmelterEventType2.VIDEO_INPUT_DELIVERED) {
  ...
  } else if (event.type === SmelterEventType2.VIDEO_INPUT_PLAYING) {
    if (event.inputRef.type === "global") {
      store.dispatchUpdate({
        type: "update_input",
  ...
  } else if (event.type === SmelterEventType2.VIDEO_INPUT_EOS) {
    if (event.inputRef.type === "global") {
      store.dispatchUpdate({
        type: "update_input",
  ...
  } else if (event.type === SmelterEventType2.AUDIO_INPUT_DELIVERED) {
    if (event.inputRef.type === "global") {
      store.dispatchUpdate({
        type: "update_input",
  ...
  } else if (event.type === SmelterEventType2.AUDIO_INPUT_PLAYING) {
    if (event.inputRef.type === "global") {
      store.dispatchUpdate({
        type: "update_input",
  ...
  } else if (event.type === SmelterEventType2.AUDIO_INPUT_EOS) {
    if (event.inputRef.type === "global") {
      store.dispatchUpdate({
        type: "update_input",
...
var Smelter = class {
  ...
  constructor(manager, logger) {
    ...
    this.store = new internal_exports.LiveInputStreamStore(logger);
    this.logger = logger;
  }
  async init() {
...
(function(LoggerLevel2) {
  ...
  LoggerLevel2["INFO"] = "info";
  LoggerLevel2["DEBUG"] = "debug";
  LoggerLevel2["TRACE"] = "trace";
})(LoggerLevel || (LoggerLevel = {}));

// ../../smelter-web-client/dist/esm/index.mjs
async function sendRequest(baseUrl, request) {
  ...
  if (response.status >= 400) {
    const err = new Error(`Request to Smelter server failed.`);
...
async function sendMultipartRequest(baseUrl, request) {
  const response = await fetch(joinUrl(baseUrl, request.route), {
    method: request.method,
    body: request.body
  });
...
async function sleep2(timeoutMs) {
  await new Promise((res) => {
    setTimeout(() => {
      res();
    }, timeoutMs);
...
async function retry(fn, retry2) {
  let count = 0;
  while (true) {
    count += 1;
    try {
  ...
  async connect(logger) {
    ...
    await new Promise((res, rej) => {
      ...
      ws.addEventListener("message", (data) => {
        const event = parseEvent2(data, logger);
        if (event) {
      ...
      this.donePromise = new Promise((res2) => {
...
function parseEvent2(event, logger) {
  try {
...
async function getSmelterStatus(manager) {
...
var RemoteInstanceManager = class {
  url;
  wsConnection;
  constructor(opts) {
    let url;
  ...
  async sendMultipartRequest(request) {
...
var Smelter2 = class {
  ...
  scheduler;
  constructor(opts) {
    const logger = (0, import_pino.pino)({
      level: "warn",
      browser: {
        asObject: true,
        write: {
    ...
    this.coreSmelter = new Smelter(new RemoteInstanceManager(opts), logger);
...
function SimpleComponent(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text_default, { style: { fontSize: 40 }, children: props.text });
}
function ExampleApp() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(View_default, { style: { direction: "column" }, children: [
    [...Array(count)].map((_value, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SimpleComponent, { text: "Example text" }, index)),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View_default, {}),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text_default, { style: { fontSize: 30 }, children: [
      "Text component example (fontSize=",
      30,
      ")"
    ] }),
    "Raw text example (default fontSize=",
    50,
    ")",
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View_default, {}),
    "Counter: ",
...
async function run() {
  const smelter = new Smelter2({ url: "http://localhost:8081" });
  await smelter.init();
  await smelter.registerOutput("output_1", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExampleApp, {}), {
    type: "rtmp_client",
